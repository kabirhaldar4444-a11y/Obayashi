...
import { 
  ...
  Compass, Activity, ArrowRight, ShieldCheck 
} from 'lucide-react';
...
export default function ProjectDetail() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[-10%] left-[20%] w-[45vw] h-[45vw] bg-blue-500/[0.02] rounded-full blur-[140px] pointer-events-none z-0" />

      {/* ── 1. CINEMATIC HERO HEADER ── */}
      <header className="relative w-full h-[62vh] min-h-[480px] max-h-[680px] overflow-hidden flex items-end z-10">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Vertical and horizontal dark styling wraps */}
          <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/60 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-r from-slate-950/50 via-transparent to-transparent" />
        </div>

        {/* Floating Back Navigation handle */}
        <div className="absolute top-8 left-6 md:left-12 z-20">
          <button 
            onClick={() => navigate('/works')}
            className="flex items-center gap-2.5 px-5 py-3 rounded-full bg-slate-900/60 hover:bg-amber-600 text-slate-200 hover:text-white border border-slate-700/50 hover:border-amber-600 font-bold transition-all duration-300 shadow-2xl backdrop-blur-md cursor-pointer group"
          >
        ...
        <div className="container mx-auto px-6 md:px-12 pb-16 relative z-10">
          <div className="max-w-4xl">
            ...
            <motion.div 
              ...
              className="inline-flex items-center px-4 py-1.5 text-[10px] font-extrabold tracking-widest uppercase bg-amber-600/90 text-white border border-amber-500/30 rounded-md mb-6 shadow-lg backdrop-blur-sm"
            >
              {project.category}
            </motion.div>
      ...
      {/* ── 2. METRICS HUB (Glassmorphic Cards) ── */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <motion.section 
              ...
              className="bg-slate-900/30 border border-white/[0.06] backdrop-blur-xl rounded-3xl p-8 md:p-10 shadow-lg hover:border-amber-500/20 transition-all duration-300"
            >
              ...
              <p className="text-slate-350 leading-relaxed text-base md:text-[17px] font-light">
                {project.description}
              </p>
            </motion.section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <motion.div 
                ...
                className="bg-slate-900/30 border-l-4 border-l-rose-500 border-t border-r border-b border-white/[0.06] backdrop-blur-xl rounded-3xl p-8 shadow-lg transition-all duration-300 group"
              >
              ...
              <motion.div 
                ...
                className="bg-slate-900/30 border-l-4 border-l-emerald-500 border-t border-r border-b border-white/[0.06] backdrop-blur-xl rounded-3xl p-8 shadow-lg transition-all duration-300 group"
              >
            ...
            {/* Development Timeline (Glowing and modern vertical tracking line) */}
            <motion.section 
              variants={cardSlideUp}
          ...
          <div className="space-y-8">
            ...
            >
              {/* Subtle background tech matrix grid */}
        ...
        {/* ── 4. RELATED PROJECT CASE STUDIES BLOCK ── */}
        <section className="mt-24 border-t border-white/[0.08] pt-16">
          <div className="flex items-end justify-between mb-10">
            <div>
              <h2 className="text-2xl font-black text-white mb-2">Related Project Case Studies</h2>
              <p className="text-sm text-slate-400">Explore other high-profile developments in Japan</p>
            </div>
            <Link to="/works" className="hidden md:flex items-center gap-1.5 text-xs font-bold text-amber-500 hover:text-amber-400 transition-colors uppercase tracking-widest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {relatedProjects.map((p) => (
              <Link 
                ...
                className="bg-slate-900/20 border border-white/[0.06] hover:border-amber-500/40 hover:shadow-2xl rounded-2xl overflow-hidden group hover:-translate-y-1.5 transition-all duration-300 flex flex-col h-full"
              >
                <div className="h-48 w-full overflow-hidden relative">
                  ...
                  />
                  <div className="absolute top-4 left-4 px-2.5 py-1 text-[9px] font-extrabold tracking-widest uppercase bg-slate-950/80 text-white rounded border border-white/[0.08] shadow-sm backdrop-blur-sm">
                    {p.category}
                  </div>
                </div>
                <div className="p-6 flex flex-col flex-grow bg-slate-900/10">
                  <h4 className="font-extrabold text-slate-100 group-hover:text-amber-400 line-clamp-1 transition-colors text-base mb-3">
                    {p.title}
                  </h4>
                  <div className="flex items-center gap-1.5 text-xs text-slate-400 mt-auto pt-4 border-t border-white/[0.04]">
