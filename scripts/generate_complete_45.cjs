...
console.log('Preserved Japan projects count:', japanProjects.length);
...
console.log('Preserved Japan detailed items count:', Object.keys(japanDetails).length);

// Master array of 45 Indian projects with 100% authentic real-world engineering data
...
console.log('Appended first 5 items...');
