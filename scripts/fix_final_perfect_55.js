...
const perfectMap = {
  ...
  'work_fukutoku_toyosu_101': 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?q=80&w=1600&auto=format&fit=crop',
...
async function run() {
  console.log('Downloading 55 perfect project images...');
  for (const [id, url] of Object.entries(perfectMap)) {
  ...
  // Deduplicate hashes cleanly with asset tags
  ...
  console.log('Finished 55 perfect project images verification.');
}
