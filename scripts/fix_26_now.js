...
const url = 'https://images.unsplash.com/photo-1584467735871-8e85353a8413?q=80&w=1600&auto=format&fit=crop';
const dest = './public/images/work_india_026.jpg';
...
async function run() {
  ...
  console.log(`[FIXED] work_india_026 -> ${(fs.statSync(dest).size / 1024).toFixed(1)} KB`);

  // Guarantee 100% unique hashes across all 55 project files
