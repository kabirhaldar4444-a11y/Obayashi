...
// 45 Projects Master Array
const rawList = [
  // 1: Pune International Airport Expansion
  {
  ...
  // 2: Tidel Park Chennai Expansion
  {
  ...
  // 3: Shendra-Bidkin Industrial Area
  {
...
console.log('Appended 5 items. Now compiling remaining 40 items in modular blocks...');
