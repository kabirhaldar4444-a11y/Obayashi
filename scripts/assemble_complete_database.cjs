...
// 2. Read existing Japan detailedProjectContent
...
console.log('Preserved Japan detailed items:', Object.keys(japanDetails).length);

// 3. Load all 45 Indian project parts
const part1 = [
  // 1
  {
    id: "work_india_001", slNo: 1,
    ...
    category: "Aviation", designType: "Design & Build", location: "Maharashtra", area: "200 acres", budget: "₹3,000-4,000 crores", deadline: "2033", completionYear: "2033",
    prefecture: "Maharashtra", city: "Pune", airportName: "Pune International Airport (PNQ)", coordinates: "18.5822° N, 73.9197° E",
    ...
    detailsList: [{ label: "Sector", value: "Aviation Infrastructure" }, { label: "Sub-Sector", value: "Airport Terminal & Airside" }, { label: "Budget", value: "₹3,000–4,000 Crores" }, { label: "Area", value: "200 Acres (52,000+ m² NITB)" }, { label: "Deadline", value: "2033" }, { label: "Location", value: "Pune, Maharashtra" }],
    kanjiName: "プネー国際空港ターミナル拡張事業", romajiName: "Punē Kokusai Kūkō Tāminaru Kakuchō Jigyō",
    ...
    challenges: ["Executing heavy structural steel framing and deep foundation piling within an active defense airfield under stringent flight safety and radar interference restrictions.", "Managing complex passenger diversion and live airfield pavement connections during highly restricted midnight non-flight curfew hours."],
    solutions: ["Deployed 3D Building Information Modeling (BIM) paired with GPS-calibrated crane positioning to ensure structural steel assemblies remained strictly within aviation clearance envelopes.", "Utilized off-site modular steel prefabrication and rapid-curing high-strength concrete mixes to achieve accelerated night-shift apron paving."],
    timeline: [
    ...
    specs: { "Structure": "Composite Structural Steel Frame & Reinforced Concrete", "Foundation": "Cast-in-Place Bored Concrete Piles (35m depth)", "Steel Used": "High-Tensile Structural Steel Grade E350/E450", "Concrete Grade": "High-Performance Concrete M40/M50", "Terminal Area": "52,000+ m² Multi-Level Terminal Building", "Apron Capacity": "16 Code-C Aircraft Parking Bays", "Passenger Capacity": "16+ Million Passengers Per Annum (MPPA)", "Seismic Resistance": "Seismic Zone III Compliant Ductile Frame", "Energy Rating": "GRIHA 4-Star & LEED Gold Target", "Executing Agency": "Airports Authority of India (AAI) & MADC", "Construction Method": "Prefabricated Long-Span Steel Truss & Rapid Night Paving" },
    culturalInsight: { title: "飛翔", meaning: "Embodying the spirit of 'Hishō' (soaring flight), the Pune Airport expansion connects Maharashtra's industrial ingenuity directly with global commercial skylines.", quote: "「鵬程万里」", quoteTranslation: "Embarking on a noble journey of ten thousand miles." }
  },

  // 2
  {
    id: "work_india_002", slNo: 2,
    ...
    category: "Commercial Infrastructure", designType: "Design & Build", location: "Tamil Nadu", area: "50 acres", budget: "₹1,500-2,000 crores", deadline: "2031", completionYear: "2031",
    prefecture: "Tamil Nadu", city: "Chennai", airportName: "Chennai International Airport (MAA)", coordinates: "12.9863° N, 80.2432° E",
    ...
    detailsList: [{ label: "Sector", value: "Commercial Infrastructure" }, { label: "Sub-Sector", value: "IT/ITES Technology Parks" }, { label: "Budget", value: "₹1,500–2,000 Crores" }, { label: "Area", value: "50 Acres (~3.5 Million sq. ft. Built-up)" }, { label: "Deadline", value: "2031" }, { label: "Location", value: "Chennai, Tamil Nadu" }],
    kanjiName: "タイデル・パーク・チェンナイ拡張計画", romajiName: "Taideru Pāku Chennai Kakuchō Keikaku",
    ...
    challenges: ["Designing deep subterranean basement structures in coastal soil conditions subject to high water tables and seasonal cyclone storm surges.", "Achieving massive column-free interior floor spans to accommodate modern agile enterprise workstations while ensuring superior seismic dampening."],
    solutions: ["Installed continuous reinforced concrete diaphragm slurry walls combined with multi-stage deep dewatering systems during basement excavation.", "Engineered post-tensioned bonded slab systems and composite steel moment frames to maximize usable interior space and structural efficiency."],
    timeline: [
    ...
    specs: { "Structure": "Composite Steel-Concrete Core with Post-Tensioned Slabs", "Foundation": "Diaphragm Retaining Walls with Bored Piles (32m depth)", "Steel Used": "High-Strength Thermo-Mechanically Treated (TMT) Fe550D", "Concrete Grade": "High-Performance Self-Compacting Concrete M50", "Building Height": "85–110 meters (Twin High-Rise Towers)", "Built-up Area": "3,500,000 sq. ft. Grade-A Office Space", "Parking Capacity": "4,200 vehicles with smart EV charging bays", "Seismic Resistance": "Seismic Zone III Compliant Ductile Shear Walls", "Energy Rating": "LEED Platinum & IGBC Platinum Certified", "Executing Agency": "TIDEL Park Ltd, TIDCO & ELCOT", "Construction Method": "Post-Tensioned Flat Slabs & Unitized Facade Assembly" },
    culturalInsight: { title: "智", meaning: "Reflecting 'Chi' (intellect and digital wisdom), Tidel Park stands as an enduring monument to Tamil Nadu's software innovation and global engineering workforce.", quote: "「知識は力なり」", quoteTranslation: "Knowledge is the supreme architect of progress." }
  },

  // 3
  {
    id: "work_india_003", slNo: 3,
    ...
    category: "Industrial Infrastructure", designType: "Design & Build", location: "Maharashtra", area: "500 acres", budget: "₹2,500-3,500 crores", deadline: "2030", completionYear: "2030",
    prefecture: "Maharashtra", city: "Chhatrapati Sambhajinagar (Aurangabad)", airportName: "Aurangabad Airport (IXU)", coordinates: "19.8762° N, 75.3433° E",
    ...
    detailsList: [{ label: "Sector", value: "Industrial Infrastructure" }, { label: "Sub-Sector", value: "Smart Industrial City / DMIC Node" }, { label: "Budget", value: "₹2,500–3,500 Crores" }, { label: "Area", value: "500 Acres (Part of 10,000-acre AURIC master plan)" }, { label: "Deadline", value: "2030" }, { label: "Location", value: "Chhatrapati Sambhajinagar, Maharashtra" }],
    kanjiName: "シェンドラ・ビドキン スマート工業都市", romajiName: "Shendora Bidokin Sumāto Kōgyō Toshi",
    ...
    challenges: ["Laying hundreds of kilometers of multi-utility underground duct networks in basalt rock terrain while maintaining precise gravitational drainage gradients.", "Guaranteeing zero liquid discharge across a diverse mix of heavy industrial chemical, automotive, and metallurgical manufacturing tenants."],
    solutions: ["Utilized specialized trenching machinery, rock-breakers, and 3D GIS subsurface mapping to coordinate utility duct alignments through basalt strata.", "Engineered centralized SCADA-controlled wastewater collection pipelines linked to advanced multi-effect evaporators and membrane filtration systems."],
    timeline: [
    ...
    specs: { "Structure": "Greenfield Smart Industrial City Infrastructure", "Foundation": "Hard Basalt Rock Excavation with Reinforced Concrete Foundations", "Road Network": "Heavy-Duty 4/6-Lane Rigid Concrete Pavements (PQC)", "Concrete Grade": "Pavement Quality Concrete M40 / Structural M45", "Effluent Treatment": "Zero Liquid Discharge (ZLD) CETP with RO & MEE", "Power Reliability": "220/33kV Dual-Source Dedicated Underground Substations", "Water Supply": "Dedicated Raw Water Pipeline from Jayakwadi Dam with SCADA", "Seismic Resistance": "Seismic Zone II Compliant Infrastructure", "Digital Grid": "Citywide Optical Fiber with Integrated Command & Control Centre", "Executing Agency": "Maharashtra Industrial Township Limited (MITL) & NICDC", "Construction Method": "Underground Multi-Utility Trenching & Modular Infrastructure" },
    culturalInsight: { title: "創", meaning: "Embodying 'Sō' (creation and manufacturing excellence), AURIC transforms ancient Marathwada into an ultra-modern manufacturing engine for global industry.", quote: "「百錬成鋼」", quoteTranslation: "Through hundredfold tempering, pure steel is forged." }
  },

  // 4
  {
    id: "work_india_004", slNo: 4,
    ...
    category: "Industrial Infrastructure", designType: "Design & Build", location: "Odisha, Andhra Pradesh, Tamil Nadu", area: "1,000 km", budget: "₹20,000-25,000 crores", deadline: "2034", completionYear: "2034",
    prefecture: "Odisha, Andhra Pradesh & Tamil Nadu", city: "Eastern Seaboard", airportName: "Visakhapatnam (VTZ) / Chennai (MAA) / Bhubaneswar (BBI)", coordinates: "17.6868° N, 83.2185° E",
    ...
    detailsList: [{ label: "Sector", value: "Industrial Infrastructure" }, { label: "Sub-Sector", value: "Coastal Industrial Corridor / Port Connectivity" }, { label: "Budget", value: "₹20,000–25,000 Crores" }, { label: "Length / Area", value: "1,000 km Multi-State Coastal Alignment" }, { label: "Deadline", value: "2034" }, { label: "Location", value: "Odisha, Andhra Pradesh, Tamil Nadu" }],
    kanjiName: "東海岸経済回廊開発事業", romajiName: "Higashi Kaigan Keizai Kairō Kaihatsu Jigyō",
    ...
    challenges: ["Constructing durable heavy-freight road and rail infrastructure across soft, saturated coastal alluvium and cyclone-vulnerable tidal deltas.", "Coordinating multi-state environmental and coastal regulation zone (CRZ) clearances across hundreds of rivers, estuaries, and agricultural wetlands."],
    solutions: ["Applied geosynthetic reinforcement, stone columns, and prefabricated vertical drains to accelerate coastal soil settlement and prevent embankment rutting.", "Used high-performance silica-fume concrete and epoxy-coated rebar for all maritime bridges and estuarine culverts to prevent marine chloride corrosion."],
    timeline: [
    ...
    specs: { "Structure": "Multi-Modal Coastal Industrial & Transportation Corridor", "Foundation": "Ground Improvement with PVD & Deep Bored Marine Piles", "Highway Length": "1,000 km 4/6-Lane Access-Controlled Expressways", "Concrete Grade": "Corrosion-Resistant Marine Concrete M45/M50", "Steel Used": "Epoxy-Coated Corrosion-Resistant Rebar (CRS)", "Ports Connected": "Paradip, Visakhapatnam, Kakinada, Krishnapatnam, Chennai", "Industrial Nodes": "Multiple Industrial Townships across Odisha, AP & Tamil Nadu", "Seismic & Cyclone": "Seismic Zone III & Cyclone Wind Resistant (250 km/h)", "Logistics Hubs": "Multi-Modal Logistics Parks (MMLPs) & Dry Ports", "Funding & Execution": "NICDC, State Governments & Asian Development Bank (ADB)", "Construction Method": "Geosynthetic Embankment Stabilization & Precast Bridge Spans" },
    culturalInsight: { title: "海", meaning: "Representing 'Kai' (the ocean of opportunity), the East Coast Corridor connects India's historic maritime trade routes with next-generation global industries.", quote: "「海納百川」", quoteTranslation: "The ocean is vast because it welcomes all rivers." }
  },

  // 5
  {
    id: "work_india_005", slNo: 5,
    ...
    category: "Industrial Infrastructure", designType: "Design & Build", location: "Telangana", area: "1,000 acres", budget: "₹6,000-8,000 crores", deadline: "2032", completionYear: "2032",
    prefecture: "Telangana", city: "Hyderabad (Mucherla)", airportName: "Rajiv Gandhi International Airport (HYD)", coordinates: "17.1500° N, 78.5200° E",
    ...
    detailsList: [{ label: "Sector", value: "Industrial Infrastructure" }, { label: "Sub-Sector", value: "Pharmaceutical & Life Sciences Park / NIMZ" }, { label: "Budget", value: "₹6,000–8,000 Crores" }, { label: "Area", value: "1,000 Acres Phase I (Part of 19,000-acre master plan)" }, { label: "Deadline", value: "2032" }, { label: "Location", value: "Mucherla / Hyderabad, Telangana" }],
    kanjiName: "ハイデラバード・ファーマ・シティ開発計画", romajiName: "Haiderabādo Fāma Shiti Kaihatsu Keikaku",
    ...
    challenges: ["Eliminating the environmental footprint of toxic chemical and pharmaceutical effluents across hundreds of industrial manufacturing units.", "Installing extensive high-pressure steam, hazardous chemical, and treated water pipeline networks across complex granitic terrain."],
    solutions: ["Constructed a multi-tier Zero Liquid Discharge (ZLD) centralized treatment complex with multi-effect evaporators and biological membrane reactors.", "Engineered reinforced concrete utility service trenches with leak-detection sensors and automatic isolation valves for hazardous chemical transport."],
    timeline: [
    ...
    specs: { "Structure": "Greenfield Mega Life-Sciences & Pharma Industrial City", "Foundation": "Granite Bedrock Excavation with Reinforced Concrete Bases", "Effluent Treatment": "100 MLD Zero Liquid Discharge (ZLD) Centralized CETP", "Concrete Grade": "Chemical-Resistant Sulfate-Resisting Concrete M45", "Utilities": "Centralized High-Pressure Steam & Hazardous Fluid Ducts", "Water Supply": "Dedicated Krishna River Pipeline with Advanced Desalination", "Power Network": "220/33kV Sub-stations with Dedicated Pharma Power Ring", "Testing Standards": "US FDA, WHO & EU-GMP Compliant Quality Infrastructure", "Logistics": "Integrated Temperature-Controlled Cold-Chain Cargo Grid", "Executing Agency": "Telangana State Industrial Infrastructure Corporation (TSIIC)", "Construction Method": "ZLD Effluent Treatment Engineering & Heavy Pipeline Trenching" },
    culturalInsight: { title: "薬", meaning: "Reflecting 'Yaku' (medicine and healing), Hyderabad Pharma City builds the physical infrastructure that delivers life-saving pharmaceuticals to billions worldwide.", quote: "「医は仁術なり」", quoteTranslation: "The practice of medicine is an art of benevolence." }
  }
];

const part2 = require('./indian_projects_part2.cjs');
const part3 = require('./indian_projects_part3.cjs');
const part4 = require('./indian_projects_part4.cjs');
const part5 = require('./indian_projects_part5.cjs');

const allIndian = [...part1, ...part2, ...part3, ...part4, ...part5];
console.log('Total Indian Projects assembled:', allIndian.length);

if (allIndian.length !== 45) {
  throw new Error(`Expected 45 Indian projects, but got ${allIndian.length}`);
}

// 4. Construct complete worksContent.js projects array
const newProjectsArray = [];

// First add Japan projects
japanProjects.forEach(p => {
  newProjectsArray.push(p);
});

// Then add 45 Indian projects
allIndian.forEach((p, idx) => {
  const numStr = String(p.slNo).padStart(3, '0');
  const imageFileName = `work_india_${numStr}.jpg`;
...
console.log('Total combined projects for worksContent.js:', newProjectsArray.length);

// 5. Construct complete detailedProjectContent object for projectDetails.js
const newDetailedContent = { ...japanDetails };

allIndian.forEach((p, idx) => {
  newDetailedContent[p.id] = {
    kanjiName: p.kanjiName,
    romajiName: p.romajiName,
    prefecture: p.prefecture,
    city: p.city,
    tokyoDistance: p.airportName,
...
console.log('Total combined detailed content keys:', Object.keys(newDetailedContent).length);

// 6. Write worksContent.js
const worksContentCode = `// Works content and project definitions
...
fs.writeFileSync('src/data/worksContent.js', worksContentCode, 'utf8');
console.log('Successfully wrote src/data/worksContent.js!');

// 7. Write projectDetails.js
const projectDetailsCode = `// Detailed Project Data for Works Detail View and Interactive Maps
export const detailedProjectContent = ${JSON.stringify(newDetailedContent, null, 2)};
`;

fs.writeFileSync('src/data/projectDetails.js', projectDetailsCode, 'utf8');
console.log('Successfully wrote src/data/projectDetails.js!');
